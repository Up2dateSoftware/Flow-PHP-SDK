 ...
 * Class Collection.
 *
 * @template TFlowObject of FlowObject
 * @template-implements \IteratorAggregate<TFlowObject>
 *
 * @property string $object
 * @property string $url
 * @property bool $has_more
 * @property TFlowObject[] $data
 */
class Collection extends FlowObject implements \Countable, \IteratorAggregate
{
    ...
    public function all($params = null, $opts = null)
    {
        ...
        $obj = Util::convertToFlowObject($response, $opts);
    ...
    public function create($params = null, $opts = null)
    {
        ...
        return Util::convertToFlowObject($response, $opts);
    }
    ...
    /**
     * @return \Generator|TFlowObject[] A generator that can be used to
